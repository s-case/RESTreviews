...
/* JavaAlgosentimentAnalysisModel class is responsible to model any data the sentimentAnalysis resource handles. Since this one 
 is not automatable, the developer has to manually define it by providing its properties and setter/getter functions.*/
public class JavaAlgosentimentAnalysisModel{

    /* There follows a list with the properties that model the sentimentAnalysis resource, as prescribed in the service CIM*/
