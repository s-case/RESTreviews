...
public class JavaAlgosearchController{
    ...
    public JavaAlgosearchModel getsearch( @DefaultValue("guest") @HeaderParam("authorization") String authHeader,  @QueryParam("searchKeyword") String searchKeyword, @QueryParam("searchProductCategory") String searchProductCategory, @QueryParam("searchProductTitle") String searchProductTitle, @QueryParam("searchProductDescription") String searchProductDescription){

		//create a new GetsearchHandler
		GetsearchHandler oGetsearchHandler = new GetsearchHandler( authHeader, searchKeyword, searchProductCategory, searchProductTitle, searchProductDescription, oApplicationUri);
