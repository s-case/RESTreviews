...
public class JavaaccountController{
    ...
    public JavaaccountModel putaccount(@HeaderParam("authorization") String authHeader, @PathParam("accountId") int accountId,  JavaaccountModel oJavaaccountModel){
        PutaccountHandler oPutaccountHandler = new PutaccountHandler(authHeader, accountId, oJavaaccountModel, oApplicationUri);
